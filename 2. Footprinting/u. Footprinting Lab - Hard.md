...
# Check for each mail box to see if there is mail
? SELECT Notes # No mail here (Exist = 0)
? SELECT INBOX # There is one mail !
? SEARCH 1 ALL # To find mail ID
? FETCH 1 ALL
? FETCH BODY[TEXT]
...
There is a MySQL DB running on the server
