...
![Shipping containers and cranes at a port with a PHP notice about an undefined variable.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/23/data_wrapper_id.png)
